...
class Locators():
    ...
    LOGIN_EMAIL_INPUT = (By.XPATH, "//input[@type='text']")  #Поле для логина на странице входа
    LOGIN_PASSWORD_INPUT = (By.XPATH, ".//input[@type='password']")  #Поле для пароля на странице входа
    ...
    LOGO_BURGERS = (By.XPATH, '//div/a[@href="/"]') #Лого сайта
    ...
    FOOTER_TEXT = (By.XPATH, '//p[text() = "В этом разделе вы можете изменить свои персональные данные"]') #Текст в нижней части личного кабинета