...
class TestStellarBurgers:
    def test_login_personal_account_button(self, driver):
        ...
        driver.find_element(*Locators.PERSONAL_ACCOUNT).click()
        assert conftest.wait_for_element_located(driver, time=17, locator=Locators.FOOTER_TEXT, condition=EC.visibility_of_element_located)
    ...
    def test_login_restore_password_page(self, driver):
        ...
        conftest.wait_for_element_located(driver, time=10, locator=Locators.PERSONAL_ACCOUNT, condition=EC.presence_of_element_located)
        driver.find_element(*Locators.PERSONAL_ACCOUNT).click()
        assert conftest.wait_for_element_located(driver, time=10, locator=Locators.FOOTER_TEXT, condition=EC.visibility_of_element_located)